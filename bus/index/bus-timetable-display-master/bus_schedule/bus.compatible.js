...
var Infoboard = {
	init: function init(container, data, isshowbusinfo, language) {
		...
		var _tableselector = function _tableselector() {
			...
			for (var i = 0; i <= timetable.length="" -="" 1;="" i++)="" {="" var="" f="timetable[i].filter[0];" if="" (f(timetable[i].filter[1]))="" return="" timetable[i]._id;="" the="" original="" index="" }="" -1;="" };="" _switchlanguage="function" _switchlanguage(dst_lang)="" dst_lang="" must="" be="" lowercase="" map="" language="" file="" of="" bus.js="" (dst_lang="==" undefined)="" translate()="" may="" undefined="" no="" section="" is="" in="" json="" return;="" !="=" me.language)="" check="" a="" full-text="" match="" exists="" for="" (var="" key="" me.dic.data)="" (key="==" dst_lang)="" me.language="key;" break;="" language-based="" [lang]-[area]="" ---=""> zh-CN
